...
export default function Ecommerce() {
	...
	const data_smallbox3 = { new: 246, old: 113, url: "/", text: "View more...", icon: <Person className="w-8 h-8" /> }
	const data_smallbox4 = { new: 26, old: 13, url: "/", text: "View more...", icon: <People className="w-8 h-8" /> }
		...
		<Preloader>
			...
			<Row>
				<Column className="w-full sm:w-1/2 lg:w-1/4 mb-6 px-4">
					<SmallBox title="Total product" color="danger" data={data_smallbox1} />
				</Column>
				<Column className="w-full sm:w-1/2 lg:w-1/4 mb-6 px-4">
				...
				<Column className="w-full sm:w-1/2 lg:w-1/4 mb-6 px-4">
				  <SmallBox title="Users" color="primary" data={data_smallbox4} />
				</Column>
			</Row>

  ...
  return (
    <Preloader>
          ...
          <Card className="relative p-6 mt-6">
            ...
            <p className="text-lg mb-6 font-light">How to easily edit and customize BD Luminaries template.</p>
            ...
            <div className="relative mb-12">
              ...
              <p className="leading-relaxed font-light text-lg mx-auto pb-2">BD Luminaries is ready in light and dark mode. Very simple to change color skin, just editing html file and add <b>"dark"</b> classes like this <code className="text-pink-500">&lt;html className="dark" lang="en"&gt;</code>.</p>

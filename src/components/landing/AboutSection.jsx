...
export default function AboutSection(props) {
  ...
  description: "BD Luminaries is provided as a simple single component and makes no assumptions about how you want to break down, what API props you want to display, or where you get your data from.",
